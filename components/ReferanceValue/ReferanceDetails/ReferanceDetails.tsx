...
import Class from './ReferanceDetail.module.css'
            ...
            <div className="card__p">
                <div className="d-flex justify-content-between">
                    ...
                    <div className="d-flex gap-3">
                        <button className="btn btn-outline-primary rounded-pill py-1 px-4">New Registration</button>
                        <button className="btn btn-primary rounded-pill py-1 px-4">Correction</button>
                    </div>
                </div>
                <div className='mt-5'>
                    <div className='d-flex align-items-center mb-3'>
                        <h5 className='w-25 fs-6'>Referance value name</h5>
                        {/* <p className='border m-0 w-75 rounded-pill p-3'></p> */}
                        <input className='border m-0 w-75 rounded-3 p-3' value={500} />

                    </div>
                    <div className='d-flex align-items-center mb-3'>
                        <h5 className='w-25 fs-6'>Referance value</h5>
                        {/* <p className='border m-0 w-75 rounded-pill p-3'></p> */}
                        <input className='border m-0 w-75 rounded-3 p-3' value={500} />
                    ...
                    <div className='d-flex align-items-center mb-3'>
                        ...
                        {/* <p className='border m-0 w-75 rounded-pill p-3'></p> */}
                        <input className='border m-0 w-75 rounded-3 p-3' value={'common'} />
                    ...
                    <div className='d-flex align-items-center mb-3'>
                        ...
                        <textarea rows={4} className='border m-0 w-75 rounded-3 p-3' >
                           Recognized value of hours after work from the base date of work (unit: minutes)
                        </textarea>
                    ...
                    <div className='d-flex align-items-center mb-3'>
                        ...
                        {/* <p className='border m-0 w-75 rounded-pill p-3'></p> */}
                        <input className='border m-0 w-75 rounded-3 p-3' value={'Kim registration'} />
                    ...
                    <div className='d-flex align-items-center mb-3'>
                        ...
                        {/* <p className='border m-0 w-75 rounded-pill p-3'></p> */}
                        <input className='border m-0 w-75 rounded-3 p-3' value={'2022-01-27 09:00'} />
